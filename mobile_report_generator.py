...
def _calculate_overall_evaluation(achievement_rate, census_change_rate, is_target_achieved):
    ...
    # S評価
    if (achievement_rate >= 98 and census_change_rate >= 5) or \
       (achievement_rate >= 100 and -5 <= census_change_rate <= 5):
        return {
            'grade': 'S',
            'status': '目標達成＋顕著な改善',
            'card_class': 'card-excellent'
    ...
    # A評価
    elif (achievement_rate >= 98) or \
         (95 <= achievement_rate < 98 and census_change_rate >= 5):
        return {
            'grade': 'A',
            'status': '目標達成 or 改善傾向',
            'card_class': 'card-good'
    ...
    # B評価
    elif (95 <= achievement_rate < 98) or \
         (90 <= achievement_rate < 95 and census_change_rate >= 5):
        return {
            'grade': 'B',
            'status': '目標にやや届かず',
            'card_class': 'card-info'
    ...
    # D評価
    elif (achievement_rate < 85) or \
         (achievement_rate < 90 and census_change_rate < -5):
        return {
            'grade': 'D',
            'status': '要改善',
            'card_class': 'card-danger'
    ...
    # C評価
    elif (85 <= achievement_rate < 95 and -5 <= census_change_rate <= 5):
        return {
            'grade': 'C',
            'status': '要注意',
            'card_class': 'card-warning'
